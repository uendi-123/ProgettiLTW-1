        ...
        <nav class="navbar navbar-dark bg-dark border border-0 border-bottom border-3 border-light">
                <div class="container-fluid pe-2">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <!-- Btn Profilo e Ordini -->
                        <div class="nav-item row d-flex justify-content-between">
                            <div class="col-6">
                                <button class="btn btn-outline-light" id="collapseProfiloBtn" data-bs-toggle="collapse" data-bs-target="#collapseProfilo">Il mio profilo</button>
                            </div>
                            <div class="col-6 d-flex justify-content-end">
                                <button class="btn btn-outline-light" id="collapseOrdiniBtn" data-bs-toggle="collapse" data-bs-target="#collapseOrdini">I miei ordini</button> 
                            </div>
                        </div>
                        ...
                        <div class="row nav-item">
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                                <div class="collapse multi-collapse" id="collapseProfilo">
                                    <?php 
                                        if(!isset($_SESSION['user'])){
                                            echo '<script>
                                                    $("#collapseProfiloBtn").prop("disabled", true);
                                                    $("#collapseOrdiniBtn").prop("disabled", true);
                                                </script>';
                                        }
                                    ?>
                                    <div class="card text-white bg-dark border border-light-1 mt-2 mb-2" style="max-width: 540px;" id="profiloCard">
                                        <div class="row g-0">
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-4 bg-light">
                                                <img src="../img/UserIcon.png" alt="NO IMAGE" class="fluidImgOrdina">
                                            </div>
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12">
                                <div class="collapse multi-collapse" id="collapseOrdini">
                    ...
                    <!-- Modal Sign Up --> 
                    <div class="modal fade text-dark" id="signUpModal" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                    ...
                    <!-- Modal Sign In --> 
                    <div class="modal fade text-dark" id="signInModal" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="container-fluid modal-body d-grid">
                                <div class="row" id="containerCard">
                                    ...
                                    <form id="creditCardForm" class='needs-validation'>
